                    ...
                    @foreach ($result as $data)
                        @if(count($data['file_layer']) == 0)
                            <div class="menu-item me-0 me-lg-2">
                                <span class="menu-link navbar" id="{{$data['href']}}" data-page="{{$data['href']}}" data-link="dispatcher/{{$data['href']}}">
                            ...
                            <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
                                ...
                                <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">
                                    @foreach ($data['file_layer'] as $layer)
                                        <div class="menu-item">
                                            <a class="menu-link navbar" id="{{$layer['href']}}" data-page="{{$layer['href']}}" data-link="dispatcher/{{$layer['href']}}" href="script:;">
            ...
            <div class="app-navbar-item ms-1 ms-lg-4" id="kt_header_user_menu_toggle">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                    ...
                    <div class="menu-item px-5">
                        ...
                        <form id="logout" action="{{ route('cco-b.logout') }}" method="POST" class="d-none">
                            @csrf
                        </form>
                    </div>
                </div>
