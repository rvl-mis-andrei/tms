                                ...
                                <div class="empty_svc d-none">
                                    <div class="card-px text-center pt-20 pb-15">
                                        ...
                                        <div class="d-flex justify-content-center gap-2 gap-lg-3">
                                            <button class="btn btn-sm btn-primary er fs-7" data-bs-toggle="modal" data-bs-target="#modal_upload_masterlist">
                                                Upload Masterlist
                                            </button>
                                            <button class="btn btn-sm btn-info er fs-7" data-bs-toggle="modal" data-bs-target="#modal_fhauling_plan">
                                                Upload Hauling Plan
                                            </button>
                                        </div>
                                    </div>
