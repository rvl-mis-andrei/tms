                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        <div class="d-flex flex-column">
                            <div class="d-flex align-items-center mb-1">
                                <a href="#" class="text-gray-800 text-hover-primary fs-2 fw-bold me-3">Final Hauling Plan - August 14, 2024</a>
                        ...
                        <div class="d-flex mb-4">
                            <a href="#" class="btn btn-sm btn-primary me-3" data-bs-toggle="modal"  data-bs-target="#kt_modal_new_target">Export Report</a>
                            <div class="me-0">
                            ...
                            <div class="empty_hauling_list d-none">
                                <div class="card-px text-center pt-20 pb-15">
                                    ...
                                    <div class="d-flex justify-content-center gap-2 gap-lg-3">
                                        ...
                                        <button class="btn btn-sm btn-info er fs-6" data-bs-toggle="modal" data-bs-target="#modal_upload_fhauling_plan">
