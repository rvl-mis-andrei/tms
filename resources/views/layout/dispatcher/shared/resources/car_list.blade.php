<div class="page-car-list">
        ...
        <div class="card-header border-1 py-3">
            ...
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    ...
                    <button type="button" class="btn btn-primary hover-elevate-up" data-bs-toggle="modal" data-bs-target="#modal_add_car">
        ...
        <div class="card-body">
            <div class="d-flex flex-column flex-xl-row p-7">
                ...
                <div class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <div class="table-responsive" id="car_wrapper">
    ...
    <div class="modal fade" id="modal_add_car" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
            ...
            <div class="modal-content">
                <div class="modal-header justify-content-center" id="kt_modal_add_user_header">
                    <div class="text-center">
                        <h1 class="mb-3 modal_title">New Car Model</h1>
                ...
                <div class="modal-body px-5">
                    <form id="form_add_car" modal-id="#modal_add_car" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="/services/cluster_car/update">
                ...
                <div class="modal-footer flex-center">
                    <button type="button" modal-id="#modal_add_car" data-id="" id="" class="btn btn-primary me-4 submit">
                        <span class="indicator-label">Submit</span>
                        <span class="indicator-progress">Please wait...
                            <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                    </button>
                    <button type="button" modal-id="#modal_add_car" id="" class="btn btn-light me-3 cancel">Cancel</button>
                </div>
            </div>
        </div>
    </div>
