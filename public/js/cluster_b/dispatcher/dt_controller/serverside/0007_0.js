...
export var CarDT = function (param=false) {
    ...
    function initTable(){
        ...
        dataTableHelper.initTable(
            'services/cluster_car/datatable',
            {
                filter_status:$('select[name="filter_car_status"]').val(),
            },
            [
                {
                    data: "count",
                ...
                {
                    data: "car_name", name: "car_name", title: "Car Model",
                    className:'',
                    render(data,type,row)
                    {
                        ...
                        return `<div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <span class="text-muted fs-7">${row.shortname}</span>
                                </div>
                            </div>
                        `
                    }
                ...
                {
                    data: "car_status", name: "car_status", title: "Status",
                    sortable:false,
                    searchable:false,
                ...
                {
                    data: "shortname", name: "shortname", title: "Short Name",
                    sortable:false,
                    searchable:false,
                    visible:false,
                },
        ...
        $(`#${_table}_table`).ready(function() {
            ...
            $(`#${_table}_table`).on('click','.view-details',function(e){
                ...
                let modal_id = '#modal_add_car';
                let form = $('#form_add_car');

                let formData = new FormData;

                formData.append('id',id);
                _request.post('/services/cluster_car/info',formData)
                .then((res) => {
                    let payload = JSON.parse(window.atob(res.payload));

                    form.find('input[name="car_model"]').val(payload.car_model);
                    form.find('input[name="short_name"]').val(payload.short_name);
