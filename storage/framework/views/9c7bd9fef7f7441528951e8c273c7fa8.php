...
<body id="kt_app_body" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true"
    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
        <div class="app-page flex-column flex-column-fluid " id="kt_app_page">
           <?php echo $__env->make('layout.planner.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div class="app-container  container-fluid d-flex ">
                    <div class="app-main flex-column flex-row-fluid " id="kt_app_main">
                        <div class="d-flex flex-column flex-column-fluid">
                            ...
                            <?php echo $__env->make('layout.planner.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script src="<?php echo e(asset('js/cluster_b/planner/navbar.js')); ?>" type="module"></script>
</body>
</html>
<?php /**PATH C:\Users\Andrei\Desktop\TMS_NEW\tms\resources\views/layout/planner/app.blade.php ENDPATH**/ ?>