<div class="haulage_info_page d-none">
    <?php if($data['status'] ==1): ?>
        <div class="alert alert-dismissible bg-light-primary d-flex flex-column flex-sm-row p-5 mb-5 complete-haulage">
            ...
            <div class="d-flex flex-column pe-0 pe-sm-10">
                ...
                <span>This is to notify you that '<?php echo e($data['updated_by']); ?>' set the status of hauling plan as complete.</span>
            </div>
                        ...
                        <div class="d-flex flex-stack flex-wrap gap-4">
                            <div class="d-flex align-items-center fw-bold">
                                ...
                                <option value="All Batch"> All Batch</option>
                                    <?php for($i = 1; $i <= $data['batch_count']; $i++): ?>
                                        <option value="<?php echo e($i); ?>">Batch <?php echo e($i); ?></option>
                                    <?php endfor; ?>
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="menu menu-sub  more-actions-menu menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-4"
                            ...
                            <?php if($data['status'] ==2): ?>
                                ...
                                <?php if($data['plan_type'] == 1): ?>
                                    <div class="menu-item px-3">
                                        <a href="<?php echo e(route('cluster_b.download_tmp', ['id' => $data['encrypted_id'] ])); ?>" class="menu-link px-3 download_tmp">
                                        Download TMP
                                        </a>
                                    </div>
                                    <div class="menu-item px-3">
                                        <a href="<?php echo e(route('cluster_b.download_vismin', ['id' => $data['encrypted_id'] ])); ?>" class="menu-link px-3 download_vismin">
                                            Download Vismin
                                        </a>
                                    </div>
                                <?php endif; ?>
                                <?php if($data['plan_type'] == 2 && count($data['filenames']) < 2): ?>
                                    <div class="menu-item px-3">
                                        <a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#modal_fhauling_plan">
                                            Upload Hauling Plan
                                        </a>
                                    </div>
                                <?php elseif($data['plan_type'] == 2 && count($data['filenames']) >=2): ?>
                                ...
                                <div class="empty_svc d-none">
                                    <div class="card-px text-center pt-20 pb-15">
                                        ...
                                        <p class="text-gray-500 fs-6 fw-semibold py-7">
                                            <em> Click the button <span class="text-primary">Actions</span> and <br> select Upload <?php if($data['plan_type'] == 2): ?> Hauling Plan <?php else: ?> Masterlist <?php endif; ?></em>
                                        </p>
                                    </div>
                                </div>
                            </div>
    ...
    <?php echo $__env->make('layout.planner.shared.modal.modal_upload_hauling_plan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>

<?php /**PATH C:\Users\Andrei\Desktop\TMS_NEW\tms\resources\views/cluster_b/planner/hauling_plan/hauling_plan_info.blade.php ENDPATH**/ ?>