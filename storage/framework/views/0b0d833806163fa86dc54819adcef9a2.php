            ...
            <?php if($data->status ==1): ?>
                <div class="alert alert-dismissible bg-light-primary d-flex flex-column flex-sm-row p-5 mb-5 complete-haulage">
                    ...
                    <div class="d-flex flex-column pe-0 pe-sm-10">
                        ...
                        <span>This is to notify you that '<?php echo e(optional($data->updated_by)->fullname() ?? ''); ?>' set the status of hauling plan as complete.</span>
                    </div>
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="menu menu-sub  more-actions-menu menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-4"
                                    ...
                                    <?php if($data->status ==2): ?>
                                        ...
                                        <?php endif; ?>
                                        <?php if($data->plan_type == 1 && count($data->filenames) <1): ?>
                                            <div class="menu-item px-3">
                                                <a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#modal_upload_masterlist">
                                                    Upload Masterlist
                                                </a>
                                            </div>
                                        <?php elseif($data->plan_type == 1 && count($data->filenames) >=1): ?>
                                            <div class="separator mt-3 opacity-75"></div>
                                            <div class="menu-item px-3 mt-2">
...
<?php /**PATH C:\Users\Andrei\Desktop\TMS_NEW\tms\resources\views/cluster_b/dispatcher/dispatch/hauling_plan_info.blade.php ENDPATH**/ ?>