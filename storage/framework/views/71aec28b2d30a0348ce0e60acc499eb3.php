                            ...
                            <div class="d-flex align-items-center fw-bold">
                                ...
                                <select class="form-select form-select-transparent text-dark fs-7 lh-1 fw-bold py-0 ps-3 w-auto"
                                    ...
                                    <?php for($i = 1; $i <= $data['batch_count']; $i++): ?>
                                        <option value="<?php echo e($i); ?>" <?php echo e($i==1?'selected':''); ?>>Batch <?php echo e($i); ?></option>
                                    <?php endfor; ?>
                                </select>
                            </div>
                            <div class="d-flex align-items-center fw-bold">
...
<?php /**PATH C:\Users\Andrei\Desktop\TMS_NEW\tms\resources\views/layout/planner/shared/modal/modal_upload_hauling_plan.blade.php ENDPATH**/ ?>