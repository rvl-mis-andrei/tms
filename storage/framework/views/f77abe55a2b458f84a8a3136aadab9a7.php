                        ...
                        <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap flex-center">
                                    <div class="border border-gray-300 border-dashed rounded py-3 px-3 mb-3">
                                        <div class="fs-4 fw-bold text-gray-700">
                                            <span class="w-75px"><?php echo e($data['active_dealership']); ?></span>
                                    ...
                                    <div
                                        ...
                                        <div class="fs-4 fw-bold text-gray-700">
                                            <span class="w-50px"><?php echo e($data['active_dealership']); ?></span>
                                            <i
                                    ...
                                    <div
                                        ...
                                        <div class="fs-4 fw-bold text-gray-700">
                                            <span class="w-50px"><?php echo e($data['inactive_dealership']); ?></span>
                            ...
                            <div id="kt_user_view_details" class="collapse show">
                                <div class="pb-5 fs-6">
                                    ...
                                    <div class="text-gray-600"><?php echo e($data['name']); ?></div>
                                    ...
                                    <div class="text-gray-600">
                                        <div class="badge badge-light-<?php echo e($data['is_active']? 'success':'danger'); ?>"><?php echo e($data['is_active']? 'Active':'Inactive'); ?></div>
                                    </div>
                ...
                <div class="modal-body px-5 my-7">
                    <form id="form" modal-id="#modal_add_dealership" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="/services/client_dealership/create">
                        <div class="d-flex flex-column px-5 px-lg-10" id="kt_modal_add_user_scroll" style="max-height: 670px;">
                            ...
                            <?php if(Auth::user()->emp_cluster->cluster_id = 2): ?>
                                <div class="fv-row mb-7 fv-plugins-icon-container">
...
<?php /**PATH C:\Users\Andrei\Desktop\TMS_NEW\tms\resources\views/layout/dispatcher/shared/resources/client_info.blade.php ENDPATH**/ ?>